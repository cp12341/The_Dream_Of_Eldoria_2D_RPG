...
public class PlayerMovement : MonoBehaviour
{
    ...
    // TODO Break off the player inventory into its own component 
    ...
    void Start()
    {
        ...
        // Debug.Log("Health reset to: " + currentHealth.RuntimeValue); 
    ...
    // TODO this should also be part of the ability 
    ...
    public void Knock(float knockTime, float damage)
    {
        ...
        {
            Debug.Log("Health is 0. Player should die now.");
            this.gameObject.SetActive(false);
            Debug.Log("Player died - Game Over triggered");
    ...
    // TODO move the player flashing to its own script 
